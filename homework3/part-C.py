...
for quote in data_list:
    # Since the indices won't change by change the entire string to upper or lower cases,therefore 
    # change the string. i.e the quote to lower case
    lower_quote=quote.lower()

    # now change to query to lower case ; since find() function is case sensitive therefore, we need to convert the query to lowrcase as well.
    ...
    found_at=lower_quote.find(lower_query)
    if(found_at>=0):
        # Print the original quote with index position of lowercased quote. 
